...
def main():
    ...
    for k in [0]:
        for proj in projects:
            ...
            runBenchmark(proj, benchLoc, str(k), str(k), str(k), 'cipa')
...
def runBenchmark(benchName, benchLoc, kval, hval, scubaH, chordType):
    ...
    cmd = 'java -cp ' + chordLoc + ' -Dchord.work.dir=' + benchLoc + ' -Dchord.out.dir=' + chordDir + ' -Dchord.run.analyses=cipa-java,cipa-downcast-java' + ' chord.project.Boot'
