...
/**
 * Stub for method "boolean put(k,v)" in class java.util.HashMap.
 * 
...
public class GetTreeMapBuilder implements ICFGBuilder {
	...
	public ControlFlowGraph run(jq_Method m) {
		...
		jq_NameAndDesc ndOfRun = new jq_NameAndDesc("getValue",
				"()Ljava/lang/Object;");
		jq_Method getVal = ((jq_Class) mapEntryType)
				.getDeclaredInstanceMethod(ndOfRun);
		...
		Quad q1 = Getfield.create(0, bb, Getfield.GETFIELD_A.INSTANCE, to2,
				ro0, foRoot, null);
		// Quad q2 = Move.create(1, bb, Move.MOVE_A.INSTANCE, to4, ro2);
		Quad q3 = Invoke.create(2, bb, Invoke.INVOKEVIRTUAL_A.INSTANCE, null,
				mo, getVal.getParamTypes().length);
